                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    $all=$db->query("SELECT client.Client_ID,client.C_Fname,client.C_Lname,client.Email,client.TP,client.Status,users.F_Name,users.L_Name,client.Chat FROM client INNER JOIN users ON users.U_ID=client.Added_ID ORDER BY client.Client_ID DESC");
