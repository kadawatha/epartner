...
<head>
    ...
    <title>Epartner Admin | Post</title>
                        ...
                        <div class="card">
                            <div class="header">
                                ...
                                <form action="newpost.php" method="post">
                                    <button type="submit" class="btn btn-info btn-fill pull-right">New Post</button>
                                </form>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    $cate=$db->query("SELECT posts.Opening_day1,posts.Closing_day2,posts.Closing1,posts.Opening1,posts.P_ID,posts.Post_Name,posts.City,category.Category,posts.Opening,posts.Closing,posts.Closing_Day,posts.Opening_Day,users.F_Name,users.L_Name FROM posts INNER JOIN category ON category.C_ID=posts.C_ID INNER JOIN users ON users.U_ID=posts.U_ID ORDER BY posts.P_ID DESC");
                                    while ($allcate=$cate->fetch_assoc()){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                ...
                                                if ($Opening1=="12:00:00 am" && $Closing1=="12:00:00 am"){
                                                    $tim="";
                                                    $times="";
                                                }else{
                                                    $tim=$Opening1;
                                                ...
                                                echo $d3.$d4.'<br>('.$tim." - ".$times.')';?></td>

                                            <td>
                                                <form action="editpost.php?ID=<?php echo $allcate['P_ID'];?>" method="post">
