            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <form action="../pdf/printall.php" target="_blank" method="post">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    $all=$db->query("SELECT docs.Doc_ID,docs.Grant_No,docs.Reff_No,alladdress.Uni,posttype.Type,lettertype.LType,docs.U_Date FROM docs INNER JOIN alladdress ON docs.Alladdress_ID= alladdress.Alladdress_ID INNER JOIN posttype ON docs.Post_Type=posttype.Post_Type INNER JOIN lettertype ON lettertype.Letter_Type=docs.Letter_Type WHERE docs.U_Date='$dates' ORDER BY docs.Doc_ID DESC");
