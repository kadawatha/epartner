                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form id="add" method="post" action="edit/editallaccounts.php?ID=<?php echo $U_ID;?>&&pass=<?php echo $clientdetails['password'];?>">
                                    <div class="row">
                                        <div class="col-md-6">
                            ...
                            <form id="passw" method="post" action="edit/editallpass.php?ID=<?php echo $U_ID;?>">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
